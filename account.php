...
<style>
  @import url("https://fonts.googleapis.com/css?family=Kalam");
      ...
      body{
        background-image: url('https://i.pinimg.com/originals/b4/bf/af/b4bfafa2dccc4cf3fe24f774b3f13b12.jpg');
...
?>
<body style="background-image: url('https://i.pinimg.com/originals/b4/bf/af/b4bfafa2dccc4cf3fe24f774b3f13b12.jpg');
background-repeat: no-repeat;
background-size: cover;" >
<div class="header">
<div class="row">
<div class="col-lg-6">
<span class="logos">Presidio Campus Exam</span></div>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="account.php?q=2"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;Score</a></li>
...
<tr style="color:red"><td><b>S.N.</b></td><td><b>Quiz</b></td><td><b>Question Solved</b></td><td><b>Right</b></td><td><b>Wrong<b></td></td>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$eid=$row['eid'];
...
<table class="table table-striped title1" >
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b><td><b>Score</b></td></tr>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$e=$row['email'];
